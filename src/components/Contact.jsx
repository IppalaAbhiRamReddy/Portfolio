...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative w-full max-w-5xl min-h-[50vh] flex flex-col items-center justify-center rounded-3xl overflow-hidden border border-white/5 bg-white/[0.01]",
          isHovered ? "cursor-auto" : "cursor-none",
        )}
      >
            ...
            >
              <AvatarHoverCard
                ...
                buttonContent={
                  <button
                    onClick={() =>
                      window.open("mailto:abhiramreddyippala@gmail.com")
                    }
